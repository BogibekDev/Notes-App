...
import dev.bogibek.eslatmalar.di.AppModule_ProvideNoteDatabaseFactory;
import dev.bogibek.eslatmalar.di.AppModule_ProvideNoteRepositoryFactory;
import dev.bogibek.eslatmalar.di.AppModule_ProvideNoteUseCasesFactory;
...
import dev.bogibek.eslatmalar.feature_notes.presentation.MainActivity;
import dev.bogibek.eslatmalar.feature_notes.presentation.add_edit_note.viewmodel.AddEditViewModel;
import dev.bogibek.eslatmalar.feature_notes.presentation.add_edit_note.viewmodel.AddEditViewModel_HiltModules_KeyModule_ProvideFactory;
import dev.bogibek.eslatmalar.feature_notes.presentation.notes.viewmodel.NotesViewModel;
import dev.bogibek.eslatmalar.feature_notes.presentation.notes.viewmodel.NotesViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC extends App_HiltComponents.SingletonC {
  ...
  private static final class ActivityRetainedCImpl extends App_HiltComponents.ActivityRetainedC {
    ...
    private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
      ...
      private volatile Provider<AddEditViewModel> addEditViewModelProvider;
      ...
      private AddEditViewModel addEditViewModel() {
        return new AddEditViewModel(singletonC.noteUseCases(), savedStateHandle);
      }

      private Provider<AddEditViewModel> addEditViewModelProvider() {
        Object local = addEditViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
          addEditViewModelProvider = (Provider<AddEditViewModel>) local;
        }
        return (Provider<AddEditViewModel>) local;
      }
      ...
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("dev.bogibek.eslatmalar.feature_notes.presentation.add_edit_note.viewmodel.AddEditViewModel", (Provider) addEditViewModelProvider()).put("dev.bogibek.eslatmalar.feature_notes.presentation.notes.viewmodel.NotesViewModel", (Provider) notesViewModelProvider()).build();
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // dev.bogibek.eslatmalar.feature_notes.presentation.add_edit_note.viewmodel.AddEditViewModel 
            return (T) viewModelCImpl.addEditViewModel();

            case 1: // dev.bogibek.eslatmalar.feature_notes.presentation.notes.viewmodel.NotesViewModel 
